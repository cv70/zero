...
**Tech Stack:** Rust (2021), tokio, serde, clap, axum, rusqlite
...
**Files:**
- Create: `/home/o/space/zero/zero/Cargo.toml`
- Create: `/home/o/space/zero/zero/README.md`
...
```bash
git add Cargo.toml README.md CLAUDE.md
...
**Step 3: 添加 uuid 依赖到 zero-core/Cargo.toml**
...
**Step 3: 添加 zero-cli 到 workspace**
...
**Step 3: 添加 zero-api 到 workspace**
...
- Create: `/home/o/space/zero/zero/zero-ext/README.md`
...
```bash
mkdir -p zero-ext/tools/zero-ext-tool-files/src
mkdir -p zero-ext/memory/zero-ext-memory-filesystem/src
```

**Step 3: 创建 zero-ext-tool-files/Cargo.toml**
...
**Plan complete and saved to `docs/plans/2026-02-28-zero-implementation-plan.md`. Two execution options:**
